...
for i = 1:length(n)
    filtered = movavg(predicted_test', 'exponential', n(i));   
...
xlabel('Window Size', 'fontweight','bold','fontsize',12);
ylabel('Root Mean Squared Error (%)','fontweight','bold','fontsize',12);  
